...
<script type="text/ecmascript">
   function excluir(id){
        ...
        if(conf == true)
        {
                $.post("sql/excluir.php?acao=usuarios",{id: id}, function(pegar_dados){
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Inserir Usuário" href="cad_usuario.php"><i class="icon-plus"></i></a>
                                ...
                                <table class="table table-advance" id="table1">
                                    ...
                                    <?php
                                        ...
                                        while($rs = $read->fetch(PDO::FETCH_OBJ))
                                        {
                                            ...
                                            <td>
                                                <div class=btn-group">
                                                    <a class="btn btn-small show-tooltip" title="Editar" href="alt_usuario.php?id='.$rs->id.'"><i class="icon-edit"></i></a>
