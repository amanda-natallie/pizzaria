...
if(isset($_POST['bt_save_df']))
{
    ...
    $sql = 'INSERT INTO tbl_clientes (nome, imagem, link)';
...
?>
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i> Cadastro de Cliente</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                <form action="cad_cliente.php" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">   
