...
if(isset($_POST['bt_alt_df']))
{
    ...
    $sql2 = 'UPDATE tbl_parceiros SET nome = :titulo, link = :link';
	...
	?>     
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i> Alteração de Parceiros</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                <form action="alt_parceiro.php" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
