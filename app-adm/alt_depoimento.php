...
if(isset($_POST['bt_alt_df']))
{
    ...
    $sql2 = 'UPDATE tbl_depoimentos SET nome = :nome, resumo = :resumo, descricao = :descricao';
	...
	?>     
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i> Alteração de Depoimento</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                <form action="alt_depoimento.php" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                      ...
                                      <div class="controls">
                                         <textarea class="span6 ckeditor" rows="10" name="texto" id="texto"><?php echo $rs->descricao ?></textarea>
                                      </div>
                                   </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="ger_depoimentos.php"><button type="button" class="btn">Cancelar</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
