...
<script type="text/ecmascript">
   function excluir(id){
        ...
        if(conf == true)
        {
                $.post("sql/excluir.php?acao=eventos",{id: id}, function(pegar_dados){
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-table"></i> Gerenciamento de Eventos</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                <div class="btn-toolbar pull-right clearfix">
                                    <div class="btn-group">
                                        <a class="btn btn-circle show-tooltip" title="Adicionar Evento" href="cad_evento.php"><i class="icon-plus"></i></a>
                                    </div>
                                ...
                                <table class="table table-advance" id="table1">
                                    ...
                                    <?php
                                        ...
                                        while($rs = $read->fetch(PDO::FETCH_OBJ))
                                        {
                                            ...
                                            <td>
                                                <div class=btn-group">
                                                    <a class="btn btn-small show-tooltip" title="Editar" href="alt_evento.php?id='.$rs->id.'"><i class="icon-edit"></i></a>
