...
if(isset($_POST['bt_alt_df']))
{
    ...
    $sql2 = 'UPDATE tbl_categorias SET categoria = :categoria, keywords = :keywords, resumo = :resumo, ordem = :ordem';
    ...
    try{
        ...
        $create->bindValue(':categoria', $_POST['nome'], PDO::PARAM_STR);
                    ...
                    <div class="span12">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <form action="alt_cat.php" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="id" id="id" value="<?php echo $id ?>" />
                                    <div class="control-group">
                                        <label class="control-label" for="titulo">Ordem:</label>
                                        <div class="controls">
                                            <div class="span12">
                                                <input type="text" name="ordem" id="ordem" value="<?php echo $rs->ordem ?>" class="input-xlarge" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="span12">
                                                <input type="text" name="nome" id="nome" value="<?php echo $rs->categoria ?>" class="input-xlarge" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="span12">
                                                <input type="text" name="keywords" id="keywords" value="<?php echo $rs->keywords ?>" class="input-xlarge" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="span12">
                                                <input type="text" name="resumo" id="resumo" value="<?php echo $rs->resumo ?>" class="input-xlarge" />
                                            </div>
                                        </div>
                                    </div>
