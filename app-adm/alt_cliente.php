...
if(isset($_POST['bt_alt_df']))
{
    ...
    $sql2 = 'UPDATE tbl_clientes SET nome = :titulo, link = :link';
    ...
    try{
        ...
        if($create->execute() ){
            echo '<script type="text/javascript" >
                     location.href="ger_clientes.php";
            </script>';
	...
	?>     
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box">
                            <div class="box-title">
                                <h3><i class="icon-reorder"></i> Alteração de Cliente</h3>
                                <div class="box-tool">
                            ...
                            <div class="box-content">
                                <form action="alt_cliente.php" class="form-horizontal" id="validation-form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="ger_clientes.php"><button type="button" class="btn">Cancelar</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
